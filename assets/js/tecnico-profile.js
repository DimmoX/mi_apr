// Gestión del perfil de técnico
let isEditMode = false;
let originalUserData = {};

// Verificar autenticación y cargar datos al iniciar
document.addEventListener('DOMContentLoaded', function() {
    checkTechnicAuthentication();
    loadTechnicData();
    setupFormValidations();
});

// Verificar que el usuario sea técnico y esté autenticado
function checkTechnicAuthentication() {
...
function loadTechnicData() {
    try {
        ...
        const userData = {
            ...
            role: localStorage.getItem('role') || 'tecnico'
        };
        ...
        document.getElementById('technic-name').value = userData.name;
        document.getElementById('technic-lastname').value = userData.lastname;
        document.getElementById('technic-email').value = userData.email;
        document.getElementById('technic-phone').value = userData.phone;
        document.getElementById('role-display').value = 'Técnico';
        
        console.log('Datos del técnico cargados:', userData);
...
function toggleEditMode() {
    ...
    const fields = ['technic-name', 'technic-lastname', 'technic-email', 'technic-phone'];
    ...
    if (isEditMode) {
        ...
        document.getElementById('technic-password').value = '';
        document.getElementById('technic-confirm-password').value = '';
...
function cancelEdit() {
    ...
    document.getElementById('technic-name').value = originalUserData.name;
    document.getElementById('technic-lastname').value = originalUserData.lastname;
    document.getElementById('technic-email').value = originalUserData.email;
    document.getElementById('technic-phone').value = originalUserData.phone;
...
function setupFormValidations() {
    const form = document.getElementById('technic-profile-form');
    
    // Validación en tiempo real
    document.getElementById('technic-name').addEventListener('input', validateName);
    document.getElementById('technic-lastname').addEventListener('input', validateLastname);
    document.getElementById('technic-email').addEventListener('input', validateEmail);
    document.getElementById('technic-phone').addEventListener('input', validatePhone);
    document.getElementById('technic-password').addEventListener('input', validatePassword);
    document.getElementById('technic-confirm-password').addEventListener('input', validateConfirmPassword);
...
function validateName() {
    const nameField = document.getElementById('technic-name');
...
function validateLastname() {
    const lastnameField = document.getElementById('technic-lastname');
...
function validateEmail() {
    const emailField = document.getElementById('technic-email');
...
function validatePhone() {
    const phoneField = document.getElementById('technic-phone');
...
function validatePassword() {
    const passwordField = document.getElementById('technic-password');
...
function validateConfirmPassword() {
    const passwordField = document.getElementById('technic-password');
    const confirmField = document.getElementById('technic-confirm-password');
...
function clearValidationErrors() {
    const fields = ['technic-name', 'technic-lastname', 'technic-email', 'technic-phone', 'technic-password', 'technic-confirm-password'];
...
function handleFormSubmit(event) {
    ...
    const formData = {
        name: document.getElementById('technic-name').value.trim(),
        lastname: document.getElementById('technic-lastname').value.trim(),
        email: document.getElementById('technic-email').value.trim(),
        phone: document.getElementById('technic-phone').value.trim(),
        role: 'tecnico'
    };
    
    const newPassword = document.getElementById('technic-password').value;
    ...
    try {
        ...
        console.log('Perfil de técnico actualizado:', formData);
