// Gestión del perfil de funcionario
let isEditMode = false;
let originalUserData = {};

// Verificar autenticación y cargar datos al iniciar
document.addEventListener('DOMContentLoaded', function() {
    checkFuncionarioAuthentication();
    loadFuncionarioData();
    setupFormValidations();
});

// Verificar que el usuario sea funcionario y esté autenticado
function checkFuncionarioAuthentication() {
...
// Cargar datos del funcionario desde localStorage
function loadFuncionarioData() {
    try {
        ...
        const userData = {
            ...
            role: localStorage.getItem('role') || 'funcionario'
        };
        ...
        document.getElementById('funcionario-name').value = userData.name;
        document.getElementById('funcionario-lastname').value = userData.lastname;
        document.getElementById('funcionario-email').value = userData.email;
        document.getElementById('funcionario-phone').value = userData.phone;
        document.getElementById('role-display').value = 'Funcionario';
        
        console.log('Datos del funcionario cargados:', userData);
...
function toggleEditMode() {
    ...
    const fields = ['funcionario-name', 'funcionario-lastname', 'funcionario-email', 'funcionario-phone'];
    ...
    if (isEditMode) {
        ...
        document.getElementById('funcionario-password').value = '';
        document.getElementById('funcionario-confirm-password').value = '';
...
function cancelEdit() {
    ...
    document.getElementById('funcionario-name').value = originalUserData.name;
    document.getElementById('funcionario-lastname').value = originalUserData.lastname;
    document.getElementById('funcionario-email').value = originalUserData.email;
    document.getElementById('funcionario-phone').value = originalUserData.phone;
...
function setupFormValidations() {
    const form = document.getElementById('funcionario-profile-form');
    
    // Validación en tiempo real
    document.getElementById('funcionario-name').addEventListener('input', validateName);
    document.getElementById('funcionario-lastname').addEventListener('input', validateLastname);
    document.getElementById('funcionario-email').addEventListener('input', validateEmail);
    document.getElementById('funcionario-phone').addEventListener('input', validatePhone);
    document.getElementById('funcionario-password').addEventListener('input', validatePassword);
    document.getElementById('funcionario-confirm-password').addEventListener('input', validateConfirmPassword);
...
function validateName() {
    const nameField = document.getElementById('funcionario-name');
...
function validateLastname() {
    const lastnameField = document.getElementById('funcionario-lastname');
...
function validateEmail() {
    const emailField = document.getElementById('funcionario-email');
...
function validatePhone() {
    const phoneField = document.getElementById('funcionario-phone');
...
function validatePassword() {
    const passwordField = document.getElementById('funcionario-password');
...
function validateConfirmPassword() {
    const passwordField = document.getElementById('funcionario-password');
    const confirmField = document.getElementById('funcionario-confirm-password');
...
function clearValidationErrors() {
    const fields = ['funcionario-name', 'funcionario-lastname', 'funcionario-email', 'funcionario-phone', 'funcionario-password', 'funcionario-confirm-password'];
...
function handleFormSubmit(event) {
    ...
    const formData = {
        ...
        lastname: document.getElementById('funcionario-lastname').value.trim(),
        email: document.getElementById('funcionario-email').value.trim(),
        phone: document.getElementById('funcionario-phone').value.trim(),
        role: 'funcionario'
    };
    
    const newPassword = document.getElementById('funcionario-password').value;
    ...
    try {
        ...
        console.log('Perfil de funcionario actualizado:', formData);
